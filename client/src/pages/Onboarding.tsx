    ...
    <>
      ...
      <div className='onboarding-container'>
        ...
        <div className='p-6 pt-12 onboarding-wrapper'>
          ...
          <p className='text-slate-600 dark:text-slate-400'>Let's personalize your fitness journey</p>
        </div>
        ...
        <div className='px-6 mb-8 onboarding-wrapper'>
          ...
          <p className='text-sm text-slate-400 mt-3'>Step {step} of {totalStep}</p>
        </div>
